    ...
    return (
        <div className={'whoweare-section'}>
            <div className={'whoweare-content'}>
                <h1>WHO WE ARE</h1>
                <p className={'whoweare-text'}>We are creative and analytical minds
                    armed with solid technical skills and
                    business acumen.
                    Our mission is to improve businesses
                    ...
                    improve service quality through on-time
                    deliveries and customer feedback , there
                    is a customised data analytics solution for</p>
            </div>
        </div>
    )
};
